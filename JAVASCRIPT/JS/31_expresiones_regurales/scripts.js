/*
    ...
    Comodines:
        ...
        [aeiou] Con esto cogeríamos todas las vocales, la letra "a" y la letra "e" y la letra "i" y la letra "o" y la letra "u"

        -Rangos: Entre corchetes si ponemos un guión entre dos caracteres establecemos un rango. [a-z] Todas las letras minúsculas. (se basa en la tabla ASCII)
...
const regEx = /lorem/gi //define la expresion regular que se va a utilizar (quiero buscar la palabra lorem en todo el documento y sin tener en cuenta minusculas o mayusculas)

// Estas son otras formas de declarar expresiones regulares
const regEx2 = new RegExp('lorem', 'gi')
const regEx3 = new RegExp('/lorem/', 'gi')

console.log(regEx.test(text)) //devuelve true o false si encuentra en el texto la expresion regular (la palabra lorem)
